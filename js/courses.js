...
let loadBtn = document.querySelector('.courses__load .button');
let coursesHide = document.querySelectorAll('.courses__row .hide')

loadBtn.onclick = () => {
	if (loadBtn.innerText == 'Load More') {
		coursesHide.forEach(show => {
			show.style.display = 'block';
		});
		loadBtn.innerText = 'Close';
	}
	else {
		coursesHide.forEach(show => {
